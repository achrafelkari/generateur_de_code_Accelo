...
in event fb_start
in event m_start
in event m_stop) (namespace: null, name: default, documentation: null)org.yakindu.sct.model.sgraph.impl.StatechartImpl@b4bc72 (specification: interface IO:
var MOTOR : boolean
var SB : boolean
var FB: boolean
var M: boolean
...
in event fb_start
in event m_start
in event m_stop) (namespace: null, name: default, documentation: null)
      Boolean :  MOTOR 
      Boolean :  boolean
var SB 
      Boolean :  boolean
